...
cor_results <- cor.test(joined  %>% pull(CONT), joined %>%  pull(total)) %>%
  
  tidy()
```

* what is the rho for this correlation?
ANSWER: From the co_results dataframe, we can see that r=-0.01

* is the result significant?
ANSWER: The result is not significant as p >.05 (p=.55)

* what is the direction and size of the correlation?
ANSWER: The correlation is positive, and of size equal to 0.09 approximately (low). 
